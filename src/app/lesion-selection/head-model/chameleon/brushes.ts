export interface Brush {
  radius: number;
  startStroke(canvas: HTMLCanvasElement, position: THREE.Vector2): void;
  continueStoke(position: THREE.Vector2): void;
  finishStroke(): void;
}
...
//       for (
//         var i = -this.radius * 0.9;
//         i <= this.radius * 0.9;
//         i += this.radius / 20
//       ) {
//         this._canvasContext.beginPath();
//         this._canvasContext.moveTo(
//           this._lastPosition.x + i,
//           this._lastPosition.y + i
//         );
...
//     if (
//       this._canvasContext &&
//       position.distanceTo(this._lastPosition) > (this.radius * 2) / 3
//     ) {
//       this._lastPosition.copy(position);
//       this.drawDrop(position);
//     }
...
//     if (
//       this._canvasContext &&
//       this._lastPosition.distanceTo(position) > this.radius
//     ) {
//       this.drawStar(position, getRandomInt(0, 180));
//       this._lastPosition.copy(position);
//     }
...
//     this._canvasContext.lineWidth = this.radius * 2;
//     this._canvasContext.lineJoin = this._canvasContext.lineCap = 'round';
//     this._canvasContext.strokeStyle = this._canvasContext.createPattern(
//       this.texture,
//       'repeat'
//     );
//     this._canvasContext.moveTo(position.x, position.y);
...
//   constructor(public radius: number, public texture: HTMLCanvasElement) {}
// }
